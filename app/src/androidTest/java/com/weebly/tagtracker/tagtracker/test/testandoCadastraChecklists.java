...
public class testandoCadastraChecklists extends ActivityInstrumentationTestCase2<TelaInicialActivity> {
    ...
    public void testRun() {
        ...
        solo.enterText((android.widget.EditText) solo.getView(com.weebly.taggtracker.tagtracker.R.id.et_nombre), "ok");
        //Click on SALVAR Checklist
        solo.clickOnView(solo.getView(com.weebly.taggtracker.tagtracker.R.id.bt_guardar));
        //Click on Empty Text View
        solo.clickOnView(solo.getView(com.weebly.taggtracker.tagtracker.R.id.et_nombre));
        ...
        solo.clearEditText((android.widget.EditText) solo.getView(com.weebly.taggtracker.tagtracker.R.id.et_nombre));
        solo.enterText((android.widget.EditText) solo.getView(com.weebly.taggtracker.tagtracker.R.id.et_nombre), "gifikgdkgylgkdrjzrjsfjstkdlgdksrjsykkxfjjktdrjsktstjgktk");
        //Click on SALVAR Checklist
        solo.clickOnView(solo.getView(com.weebly.taggtracker.tagtracker.R.id.bt_guardar));
        //Click on Empty Text View
        solo.clickOnView(solo.getView(com.weebly.taggtracker.tagtracker.R.id.et_nombre));
        ...
        solo.clearEditText((android.widget.EditText) solo.getView(com.weebly.taggtracker.tagtracker.R.id.et_nombre));
        solo.enterText((android.widget.EditText) solo.getView(com.weebly.taggtracker.tagtracker.R.id.et_nombre), "Tagtracker");
        //Click on SALVAR Checklist
        solo.clickOnView(solo.getView(com.weebly.taggtracker.tagtracker.R.id.bt_guardar));
        //Click on Empty Text View
        solo.clickOnView(solo.getView(com.weebly.taggtracker.tagtracker.R.id.et_nombre));
        ...
        solo.clickOnView(solo.getView(com.weebly.taggtracker.tagtracker.R.id.btnFechaMenu));
    }
}
